        ...
        <div class="mainbar">
            ...
            <div class='article'>
                <form action="ProfilePicture" method="post" enctype="multipart/form-data">
                    <h3>Select a Profile Picture (jpg/jpeg only):</h3> <input type="file" name="pic" ></input><br></br>
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <ul class="sb_menu">
              ...
              <li class="active" ><a href="EditProfilePic.jsp">Change Profile Picture</a></li>
