        ...
        <div class="mainbar">
            <div class='article'>
                <form action="addphoto" method="Post" enctype="multipart/form-data">
                    <h3>Browse photos to add to profile:</h3>
                    <input type="file" name="img"></input>
                    <input type="submit" name="submit" value="Add Photo"></input>    
                </form>
                <div class='clr'></div>
            </div>
            ...
            <%
                            try{
                                ...
                                ps=con.prepareStatement("select photo from photos where username=?");
                                ps.setString(1, un);
                                rs=ps.executeQuery();
                                if(!rs.isBeforeFirst()){
                                    out.write("<h4>No User Photos!</h4>");
				}
                                while(rs.next()){
                                    Blob c=rs.getBlob(1);
                                    byte [] img=c.getBytes(1, (int) c.length());
                                    img64=new String(Base64.getEncoder().encode(img));
                                    out.write("<div class='article'>");
                                    out.write("<img src='data:image/jpeg;base64,"+img64+"' alt='image unavailable' width='200' height='200'></img>");
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <ul class="sb_menu">
              ...
              <li class="active"><a href="Photos.jsp">Photos</a></li>
