        ...
        <div class="mainbar">
            ...
            <div class='article'>
                <form action="password.jsp" method="post">
                    <p>Enter Existing Password: <input type="text" name="oldpass" size="25"></input><br></br></p>
                    <p>Enter New Password: <input type="password" name="newpass" size="25"></input><br></br></p>
                    <input type="submit" name="submit" value="Change Password"></input><br></br>    
                </form>
                <div class='clr'></div>
            </div>
            <%!
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <ul class="sb_menu">
              ...
              <li class="active"><a href="password change.jsp">Change Password</a></li>
            </ul>
          </div>
        </div>
        <div class="clr"></div>
