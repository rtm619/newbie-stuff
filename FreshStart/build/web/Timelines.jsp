  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
            <h2><span>Add Post</span></h2>
            <div class='article'>
                <form action="addpost.jsp" method="Post">
                    <textarea name="tx" rows="5" cols="80">Enter your thoughts...</textarea><br></br>
                    <input type="submit" name="submit" value="Post"></input>   
                </form>
                <div class='clr'></div>
            </div>
            <h2><span>Timeline Posts</span></h2>
            <%!
                String un;
                String post;
                String fn;
            ...
            <%
                            try{
                                ...
                                PreparedStatement ps=con.prepareStatement("select username,posts,likes,id from timeline order by id DESC");
                                ...
                                while(rs.next()){
                                    ...
                                    out.write("<div class='timelinebuttons'><form action='likes.jsp' method='post'>");
