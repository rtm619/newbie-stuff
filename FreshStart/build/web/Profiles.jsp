      ...
      <div class="content_bg">
        <div class="mainbar">
            ...
            <%
                            try{
                                ...
                                ps=con.prepareStatement("select email,date_of_birth,gender,contact_number,location, relationship_status, about_me from Userdata where username=?");
                                ps.setString(1, un);
                                rs=ps.executeQuery();
                                while(rs.next()){
                                    em=rs.getString(1);
        ...
        <div class="sidebar">
          ...
          <div class="gadget">
            ...
            <div class="clr"></div>
            <ul class="sb_menu">
              <li class="active"><a href="Profiles.jsp">Profile</a></li>
